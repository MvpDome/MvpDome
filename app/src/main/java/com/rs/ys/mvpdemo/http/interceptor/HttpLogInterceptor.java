package com.rs.ys.mvpdemo.http.interceptor;
...
public class HttpLogInterceptor implements Interceptor {
    ...
    private void log(String message) {
        ...
        if (message.startsWith("<-- END HTTP")) {
            Timber.i(showMessage.toString());
        }

    }

    @NonNull
    public HttpLogInterceptor setLevel(@Nullable Level level) {
    ...
    private void logForRequest(Request request, @Nullable Connection connection) {
    ...
    private void bodyToString(@NonNull Request request) {
        try {
